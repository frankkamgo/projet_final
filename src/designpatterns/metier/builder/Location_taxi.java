...
public class Location_taxi{
  ...
  private Client_taxi client;
    ...
    public String toString() {
        return "Location_taxi{" + "idloc=" + idloc + ", kmtotal=" + kmtotal + ", acompte=" + acompte + ", total=" + total + ", vehicule=" + vehicule + ", idadrdebuit=" + idadrdebuit + ", idadrfin=" + idadrfin + ", client=" + client + '}';
    }
